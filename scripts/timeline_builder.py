...
try:
    outp = subprocess.check_output(
        ["journalctl", "-o", "short-iso", "_COMM=npm", "--since", "-30d"],
        text=True,
...
with open(
    os.path.join(EVIDIR, "timeline_router_corruption.txt"), "w", encoding="utf-8"
) as fh:
