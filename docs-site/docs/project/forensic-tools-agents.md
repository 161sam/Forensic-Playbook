...
- Mirror guard messaging from [`forensic/mcp/prompts/forensic_mode.txt`](https://github.com/161sam/Forensic-Playbook/blob/main/forensic/mcp/prompts/forensic_mode.txt) so adapters and wrappers stay consistent.
