...
- **MCP/Codex Agent** – folgt Plan → Confirm → Execute, verweist auf [`forensic/mcp/prompts/forensic_mode.txt`](https://github.com/161sam/Forensic-Playbook/blob/main/forensic/mcp/prompts/forensic_mode.txt).
...
- System prompt: [`forensic/mcp/prompts/forensic_mode.txt`](https://github.com/161sam/Forensic-Playbook/blob/main/forensic/mcp/prompts/forensic_mode.txt)
